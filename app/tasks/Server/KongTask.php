...
class KongTask extends WebSocket
{
    ...
    protected function beforeServerStart(swoole_websocket_server $server)
    {
        ...
        // 初始化Response
        $this->wsResponse = Response::getInstance();
        $this->wsResponse->server = $server;
    ...
    public function message(swoole_websocket_server $server, swoole_websocket_frame $frame)
    {
        ...
        try {
            ...
            $this->wsResponse->success($fd, $id, $result);
        } catch (\Exception $ex) {
            if ($ex instanceof ExceptionInterface) {
                $this->wsResponse->fail($server, $fd, $ex->getCode(), $ex->getMessage());
            }
