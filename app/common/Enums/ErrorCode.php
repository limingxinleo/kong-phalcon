...
class ErrorCode extends Enum
{
     ...
     * @Message('参数错误')
     */
    public static $ENUM_PARAMS_ERROR = 402;

    /**
     * @Message('Kong接口报错')
     */
    public static $ENUM_KONG_API_FAIL = 403;
     ...
     * @Message('非法访问')
     */
    public static $ENUM_WEBSOCKET_ILLEGAL_REQUEST = 705;
     ...
     */
    public static $ENUM_KONG_NODES_NOT_EXIST = 3000;

    /**
     * @Message('服务Id和Name必填一项')
     */
    public static $ENUM_KONG_SERVICE_ID_OR_NAME_NOT_EXIST = 3001;

    /**
     * @Message('路由Id必填')
     */
    public static $ENUM_KONG_ROUTE_ID_NOT_EXIST = 3002;

    /**
     * @Message('消费者ID和Username必填一项')
     */
    public static $ENUM_KONG_CONSUMER_ID_OR_USERNAME_NOT_EXIST = 3003;

    /**
     * @Message('插件名必填')
     */
    public static $ENUM_KONG_PLUGIN_NAME_REQUIRED = 3004;

    /**
     * @Message('插件不存在')
     */
    public static $ENUM_KONG_PLUGIN_NAME_NOT_EXIST = 3005;

    /**
     * @Message('插件ID必填')
     */
    public static $ENUM_KONG_PLUGIN_ID_REQUIRED = 3006;
}
